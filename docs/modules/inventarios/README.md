...
- `GET /recepciones/:nped` devuelve totales calculados y la recepción activa (`docrecActivo`/`estatusRecepcion`) para que el detalle cargue los datos persistidos en lugar de una captura vacía.
