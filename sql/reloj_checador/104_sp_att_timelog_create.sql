CREATE OR ALTER PROCEDURE dbo.sp_att_timelog_create
  ...
  @EVENT_TIMESTAMP_UTC DATETIME2(0),
  @OK BIT = NULL OUTPUT,
...
BEGIN
  ...
  DECLARE @nowUtc DATETIME2(0) = @EVENT_TIMESTAMP_UTC;
  ...
  BEGIN TRY
    ...
    IF @EVENT_TIMESTAMP_UTC IS NULL
      THROW 52100, 'EVENT_TIMESTAMP_UTC es requerido', 1;
    ...
    VALUES (
      ...
      NULLIF(LTRIM(RTRIM(ISNULL(@HASH_VERIFICACION, ''))), ''),
      1
    );
