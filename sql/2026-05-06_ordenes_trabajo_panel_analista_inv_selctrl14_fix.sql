/*
  2026-05-06
  Fix panel ORD para roles de inventarios:
  - Incluye ANALISTA_INV / INVJEF en matriz operativa del SP.
  - Aplica criterio de autorizacion por selCtrlOrd=14 para dichos roles.
  - Mantiene el resto de logica vigente del SP en produccion.
*/
SET ANSI_NULLS ON;
GO
...
BEGIN
  ...
  BEGIN
    IF @IS_ADMIN = 1 OR @ROLE_CODE IN ('JEF_TALLER')
