...
BEGIN
  ...
  DECLARE @autActual NVARCHAR(40);
                                                                                                                                                                                                                           
  DECLARE @origenAutActual NVARCHAR(2);
  ...
  BEGIN TRY
    ...
    SELECT TOP 1
      ...
      @autActual = UPPER(LTRIM(RTRIM(ISNULL(AUT, ''))))
    ...
    BEGIN
      ...
      SET @sql = N'
        ...
        SELECT TOP 1 @pORIGEN = UPPER(LTRIM(RTRIM(ISNULL(ORIGEN_AUT, ''''))))
      ...
      EXEC sys.sp_executesql
        ...
        N'@pIDFOL NVARCHAR(255), @pORIGEN NVARCHAR(2) OUTPUT',
                                                                                                                                                                                               
        @pIDFOL = @idfolNorm,
                                                                                                                                                                                                                                
        @pORIGEN = @origenAutActual OUTPUT;
                                                                                                                                                                                                                  
    END
                                                                                                                                                                                                                                                      

                                                                                                                                                                                                                                                             
    SET @origenAutFinal = CASE
                                                                                                                                                                                                                               
      WHEN @serviceType IN ('DC', 'DG') THEN 'CA'
                                                                                                                                                                                                            
      WHEN ISNULL(@origenAutActual, '') IN ('CA', 'VF') THEN @origenAutActual
                                                                                                                                                                                
      WHEN ISNULL(@autActual, '') IN ('DVF', 'VF') THEN 'VF'
