/* Patch incremental: helper + create CP visible + cierre CP->CA/VF visible */

PRINT 'Aplicando dbo.sp_pv_next_visible_folio';
GO
SET ANSI_NULLS ON
GO
...
PRINT 'Aplicando dbo.sp_pvctrfolasvr_create';
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
PRINT 'Aplicando dbo.sp_pv_cotizacion_cerrar';
GO
