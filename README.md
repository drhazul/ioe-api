...
- Ordenes de trabajo / Consulta estado (2026-06-18): `PV_CTR_ORDS_ENTREGA` centraliza firma y observaciones del lote; `PV_CTR_ORDS_ENTREGA_DET` controla qué ORDs integran cada folio de entrega.
