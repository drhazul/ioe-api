...
export class SucursalEntity {
  ...
  @Column({ type: 'varchar', length: 300, name: 'direccion_completa', nullable: true })
  ...
  @Column({ type: 'varchar', length: 80, name: 'id_externo_nomina', nullable: true })
  ...
  @Column({ type: 'varchar', length: 64, name: 'sucursal_token', nullable: true })
