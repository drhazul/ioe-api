...
- Ordenes de trabajo / Consulta estado (2026-06-18): `PV_CTR_ORDS.ID_ENTREGA` enlaza la ORD con `PV_CTR_ORDS_ENTREGA`; el encabezado guarda la firma base64 de entrega una sola vez por folio y el detalle de `ESTSEGU=11` puede generar PDF de evidencia con cabecera, detalle, folio de entrega y firma.
- Ordenes de trabajo / Consulta estado (2026-06-18): `PV_CTR_ORDS_ENTREGA` concentra firma/observaciones del lote y `PV_CTR_ORDS_ENTREGA_DET` registra la composición del folio de entrega.
